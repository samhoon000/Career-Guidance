  ...
  return (
    <div className="container px-4 py-8 mx-auto max-w-5xl">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold mb-2">Cloud Engineer Learning Roadmap</h1>
        <p className="text-muted-foreground">
          Complete modules with videos, quizzes, and practical projects to master cloud engineering.
        </p>
      </div>

      <Accordion type="single" collapsible className="space-y-4" defaultValue="item-0">
        {cloudEngineerModules.map((module, idx) => {
