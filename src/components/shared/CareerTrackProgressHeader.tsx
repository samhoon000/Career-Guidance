...
import { CheckCircle2, Video, Trophy } from "lucide-react";

interface CareerTrackProgressHeaderProps {
...
export const CareerTrackProgressHeader = ({
  overallProgress,
  videosWatched,
  totalVideos,
  quizzesPassed,
  ...
  totalModules,
  trackName,
}: CareerTrackProgressHeaderProps) => {
  return (
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Keep learning to unlock your {trackName} career
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{modulesUnlocked}/{totalModules}</p>
